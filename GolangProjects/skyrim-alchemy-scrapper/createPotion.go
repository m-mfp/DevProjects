...
// RETURN WHICH EFFECTS ARE IN THE POTION IN CASE ONE OF THE EFFECTS DIDNT HAVE INGREDIENT FOR

// ADD EXTRA EFFECTS THAT COULD BE MADE IF ONLY TWO REQUESTED EFFECTS WERE PUT INTO THE POTION
